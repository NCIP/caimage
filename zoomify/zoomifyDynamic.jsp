		  ...
		  <td>
			...
			%>
			 <object style="display:block;" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="950" height="600" id="ZoomifyAnnotationViewer">
				...
				<embed flashvars="zoomifyImagePath=<%=imgPath%>&zoomifyEditMode=0&zoomifySkipUsername=1&zoomifyServerIP=<%=host %>&zoomifyTileHandlerPath=/servlet/zoomifyservlet.ZoomifyServlet&zoomifyMenuVisible=0zoomifyRulerVisible=0&zoomifyAnnotationsHide=1&zoomifyToolbarX=0&zoomifyToolbarY=100&zoomifyNavigatorHeight=100&zoomifyNavigatorX=0&zoomifyNavigatorY=0" src="ZoomifyAnnotationViewer.swf" menu="false" allowFullScreen="true" pluginspage="http://www.adobe.com/go/getflashplayer" type="application/x-shockwave-flash" width="950" height="600" name="ZoomifyAnnotationViewer"></embed>
			 </object>
