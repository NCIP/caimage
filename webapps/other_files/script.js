...
var gDocTable = new Array(
   ...
   new hrefList("slide0027.htm", 1, 24),
   ...
   new hrefList("slide0036.htm", 1, 34),
   ...
   new hrefList("slide0046.htm", 1, 40),
   new hrefList("slide0047.htm", 1, 41),
   new hrefList("slide0048.htm", 1, 42),
   new hrefList("slide0049.htm", 1, 43),
   new hrefList("slide0042.htm", 1, 44),
   new hrefList("slide0044.htm", 1, 45),
   new hrefList("slide0045.htm", 1, 46)
);
