...
<tr><td colspan="3"><h2 class="title">
		Enter Information for Stain:</h2>
	
	</td></tr>
<%
Stain st = new Stain();
String table_name = request.getParameter("table");
System.out.println("stain"+table_name);
Stain St = null;
%>
<TR ALIGN=LEFT VALIGN=TOP>
<td ALIGN=left class="bodytxbold">Staining</td>
	<td ALIGN=LEFT>	<SELECT NAME="stain"  onChange="check_other(main.Other)">
	<option value =""> </option>
	<%
	...
	for(int j =0; j < stain.size(); j++){
			...
			<%}
			System.out.println("stain:"+St.getStain_id()); 
	}
	%>	
...
<%
//System.out.println("stain number:"+document.forms['main'].stain.value); 
%>
<td ALIGN=left class="bodytxbold">If Other</td>
 <TD colspan="2"><input type="Text" size="40" name="Other" value="" ?" readonly ":"">	
	 </TD>
