...
<td ALIGN=RIGHT class="blbo"><b> Width :&nbsp;<font color="red" >*</font></b></td>
	<td>
		...
		<%System.out.println("image name  "+request.getParameter("xcoor"));%>	
		</td>
	</TR>
	<TR ALIGN=LEFT VALIGN=TOP>
	...
	<td>
		...
		<%System.out.println("image desc  "+request.getParameter("ycoor"));%>	
		</td>
	</TR>
	<TR ALIGN=LEFT VALIGN=TOP>
	...
	<td>
		...
		<%System.out.println("image desc  "+request.getParameter("magni"));%>	
	...
	<option value =""></option>	
	 ...
	 <% 
	System.out.println("the get value is"+mod);
	...
	for(int j =0; j <modalities.size(); j++){
			...
			<%}
			System.out.println(modalitiesTab.getImage_modality_id()+modalitiesTab.getImage_modality_type());
		}
	%>
