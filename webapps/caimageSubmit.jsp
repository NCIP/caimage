...
<br>
		<TR>
			<TD  class="bluhderslrg" colspan="3" align="center" valign="bottom">Image Submission
			</TD>
		</TR>
		...
		<TR align="left" valign="top">
			...
			<%System.out.println("gene name  "+request.getParameter("promoter"));%>	
			</TD>
		</TR>
		<TR align="left" valign="top">
			<td>&nbsp;</td>
			...
			<%System.out.println("gene name  "+request.getParameter("gene"));%>	
			</TD>
		</TR>
		<TR align="left" valign="top">
		...
		<TR align="left" valign="top">
			...
			<input type="text" name="PMID" size="25" maxlength="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a name="Pubmed" id="Pubmed" href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?CMD=&DB=PubMed" target="_blank"><img src="images/pubmed_70.gif" alt="Open PubMed Browser" width="70" height="24" border="1"></a>
		...
		<TR align="left" valign="top">
			<td>&nbsp;</td>
			<TD class="bodytxrequ">Image Name*
			</TD>
			<TD><INPUT align="center" name="imagetitle" size="25" maxlength="255">
			<%System.out.println("image name  "+request.getParameter("imagetitle"));%>	
			</TD>
		</TR>
		<TR align="left" valign="top">
			<td>&nbsp;</td>
			...
			<%System.out.println("image desc  "+request.getParameter("imagedesc"));%>	
			</TD>
		</TR>
		<tr><td>&nbsp;</td><td class="bodytxbold">Staining</td><td>
...
<tr><td>&nbsp;</td><td class="bodytxrequ">Image Upload*</td>
<td><INPUT type="file" name="myUploadObject" multiple></td></tr>
<tr>
