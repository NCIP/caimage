...
<% 
	...
	System.out.println(	"submitterUid from the id:"+id);
	if(id != null){
...
<%System.out.println("hidden submitteruid:"+submitterUid);%>
	...
	<br><div align="center"><font class="bluhderslrg">Create User Account</font></div> <br><br>
...
<td colspan="3" height="50" valign="top" class="bodytxrequ" align="right">* Required Fields</td>	  
</TR>
<TR ALIGN="LEFT" VALIGN="TOP">
...
<TR ALIGN="LEFT" VALIGN="TOP">
	<TD class="bodytxrequ">Submitter's Last Name:
	</TD>
...
<TR ALIGN="LEFT" VALIGN="TOP">
	<TD class="bodytxrequ">Submitter's Email: 
	</TD>
...
<TR ALIGN="LEFT" VALIGN="TOP">
	<TD class="bodytxrequ">
		Principal Investigator's Name: <br>
		(Lastname, Firstname )
		</TD>
...
<TR ALIGN="LEFT" VALIGN="TOP">
	<TD class="bodytxbold">Laboratory Name:		
	</TD>
...
<TR align="LEFT" valign="TOP">
			...
			<TD align="left">
<INPUT TYPE=SUBMIT NAME="insert_submitter" VALUE="   NEXT   &gt;&gt;&gt;">&nbsp; <INPUT TYPE=RESET VALUE="  Reset  ">
</td></tr>
	</TABLE>
...
if(request.getParameter("insert_submitter") != null){
	 ...
	 boolean flag = DatabaseSetup.checkRequiredFeilds(request,"login");
	...
	//make sure the user does not already exsist in the db
		String where = " UPPER(LASTNAME) like UPPER('" + user.getLastname() + "') and UPPER(FIRSTNAME) like UPPER('" + user.getFirstname() + "') and " +
						"UPPER(LABORATORY) like UPPER('" + user.getLaboratory() + "') and UPPER(EMAIL) like UPPER('" + user.getEmail() + "') "; 
		...
		<!--- <TABLE BORDER=0 align=center cellspacing="5" cellpadding="5">
		<TR ALIGN=left VALIGN=TOP>
		<TR><TD><h3><font color = "red">A record already exsists for you</font></h3></TD></TR>		</tr>
		</TABLE> --->
