	...
	public void run()
    {
        ...
        try
        {
			...
			{   	
				...
				System.out.println("111111str1:"+str1);
				System.out.println("files2.size():"+files2.size());
				 ...
				 if( files2 != null && files2.size()>0)// delete the old images first , then putting the new one on there
				 {
				     ...
				     {						        
							...
							System.out.println("22222222str1:"+str1+"str2:"+str2);					       
						    System.out.println(	"srt1:"+str1 +"str2:"+str2);		 
		...
		if(files.size() ==0 &&files2 != null && files2.size()>0)//delete file
			{   	
				...
				{				
					...
					System.out.println("files2.size():"+files2.size() +"str2:"+str2);
					  if(files != null && files.size()== 0)
					  {	   
					      success = this.deleteFile(str2);
		                    if ( success )
		                    ...
		                    System.out.println ("Delete failed for file..." + str2);
					  }//if
				  }//for
			}//if						
					      ...
					      success = this.deleteFile(str);
		                    if ( success )
		                      System.out.println ("\n" + str + " successfully deleted...");
		                       ...
		                       System.out.println ("Delete failed for file..." + str);					 
				       }//for
			    flag= false; 
				}//if	flag			
			if(fileArray2_ != null && fileArray2_.length >0 && flag == false){
				System.out.println("this is for constructsImg" + this.printWorkingDirectory());
				  flag2 = this.changeWorkingDirectory(path2_);	
				  System.out.println("this is for constructsImg after " + this.printWorkingDirectory());
				}
			 if(flag2 && flag == false ){
