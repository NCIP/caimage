...
public  class DOMWriter
{
  ...
  public static String nodeToString(Node node)
  {
    ...
    //System.out.println("Testing the Agent Domain 1 Object"+sw.toString());
  ...
  */
  public static  void serializeAsXML(Node node, Writer writer)
  {
    ...
    //System.out.println("Testing the Agent Domain 1.1 Object"+writer.toString());
  }
  /**
   * Printer clss to produce the output
   */
  private static  void print(Node node, PrintWriter out, boolean aflag)
  {
    if (node == null)
    {
      return;
    ...
    switch (type)
    {
      ...
      case Node.ELEMENT_NODE :
      {
        ...
        if(len==1 && aflag== true){
        //System.out.println("the flag in element is"+aflag);
        ...
        for (int i = 0; i < len; i++)
        {
        System.out.println("the value is"+len);
      ...
      case Node.ENTITY_REFERENCE_NODE :
      {
        out.print('&');
        out.print(node.getNodeName());
         //System.out.println("Testing the Agent Domain 4 Object "+node.getNodeName());
        out.print(';');
        break;
      }
 ...
 // if (Node.DOCUMENT_TYPE_NODE == node.getNodeType() && node.getChildNodes().getLength() > 0)
        ...
        str.append(">");
        //System.out.println("Testing the Agent Domain 7 Object "+str.toString());
   return (str.toString());
      }
...
//System.out.println("Testing the Agent Domain end Object"+str.toString());
    return (str.toString());
