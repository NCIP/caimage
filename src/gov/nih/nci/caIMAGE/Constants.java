...
public class Constants {
    ...
    public interface Dropdowns {
    	public static final String GENDERQUERYDROP = "genderquerydrop.db";
    	public static final String SEARCHGENDERDROP = "searchgender";    
    	public static final String INSTITUTIONQUERYDROP = "institutionquerydrop.db";
    	public static final String SEARCHINSTITUTIONDROP = "searchinstitution";
    	public static final String SEARCHSTAININGDROP = "searchstaining";
    	public static final String SEARCHSTRAINDROP = "searchstrain";
